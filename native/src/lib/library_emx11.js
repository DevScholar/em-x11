 ...
 * native/emx11/bridges.c calls. In the static-link path (-sUSE_EMX11)
...
var LibraryEmX11 = {
  ...
  $EmX11Host: {
    ...
    init: function() {
      ...
      // when the user compiles with -sUSE_EMX11 and writes zero JS glue.
  ...
  emx11_js_clipboard_read_begin__sig: 'i',
  ...
  emx11_js_clipboard_read_fetch__sig: 'iiii',
  ...
  emx11_js_clipboard_write_utf8__sig: 'vii',
  emx11_js_clipboard_write_utf8: function(dataPtr, len) {
    ...
    if (typeof navigator === 'undefined' ||
      ...
      warnOnce('[emx11] clipboard write: API unavailable');
      return;
    }
    var text = new TextDecoder('utf-8').decode(copy);
    navigator.clipboard.writeText(text).catch(function(e) {
      warnOnce('[emx11] clipboard write failed: ' + e);
    });
  },

  /* ---- core lifecycle --------------------------------------------------- */

  emx11_js_init__sig: 'vii',
  emx11_js_init: function(screenWidth, screenHeight) {
    var h = EmX11Host.get();
    if (h) h.onInit(screenWidth, screenHeight);
  },

  emx11_js_open_display__sig: 'viii',
  ...
  emx11_js_get_window_attrs__sig: 'viii',
  ...
  emx11_js_get_window_abs_origin__sig: 'viii',
  ...
  emx11_js_get_window_shape_count__sig: 'ii',
  emx11_js_get_window_shape_count: function(id) {
    var h = EmX11Host.get();
    if (!h) return -1;
  ...
  emx11_js_get_window_shape_rects__sig: 'iiii',
  emx11_js_get_window_shape_rects: function(id, dstPtr, capacity) {
  ...
  emx11_js_get_window_children_count__sig: 'ii',
  emx11_js_get_window_children_count: function(parent) {
    var h = EmX11Host.get();
    if (!h) return 0;
  ...
  emx11_js_get_window_children__sig: 'iiii',
  emx11_js_get_window_children: function(parent, dstPtr, capacity) {
  ...
  emx11_js_grab_button__sig: 'viiiiiiiii',
  emx11_js_grab_button: function(window, button, modifiers,
  ...
  emx11_js_ungrab_button__sig: 'viii',
  emx11_js_ungrab_button: function(window, button, modifiers) {
    var h = EmX11Host.get();
  ...
  emx11_js_grab_pointer__sig: 'viii',
  emx11_js_grab_pointer: function(conn_id, window, owner_events) {
    var h = EmX11Host.get();
    if (h) h.onGrabPointer(conn_id >>> 0, window >>> 0, owner_events !== 0);
  },

  emx11_js_ungrab_pointer__sig: 'v',
  emx11_js_ungrab_pointer: function() {
    var h = EmX11Host.get();
  ...
  emx11_js_schedule_repoll__sig: 'vi',
  emx11_js_schedule_repoll: function(conn_id) {
    var h = EmX11Host.get();
  ...
  emx11_js_set_input_focus__sig: 'vi',
  emx11_js_set_input_focus: function(window) {
    var h = EmX11Host.get();
  ...
  emx11_js_xim_set_focus__sig: 'vi',
  emx11_js_xim_set_focus: function(window) {
    var h = EmX11Host.get();
    if (h && h.onXimSetFocus) h.onXimSetFocus(window >>> 0);
  },

  emx11_js_xim_clear_focus__sig: 'v',
  emx11_js_xim_clear_focus: function() {
    var h = EmX11Host.get();
    if (h && h.onXimClearFocus) h.onXimClearFocus();
  },

  emx11_js_xim_set_spot__sig: 'viii',
  emx11_js_xim_set_spot: function(window, x, y) {
    var h = EmX11Host.get();
  ...
  emx11_js_exec_self__sig: 'viii',
  emx11_js_exec_self: function(conn_id, argv_ptrs, argc) {
    var args = [];
  ...
  emx11_js_get_atom_name__sig: 'ii',
  ...
  emx11_js_draw_points__sig: 'viiiiii',
  ...
  emx11_js_draw_string__sig: 'viiiiiiiiii',
  ...
  emx11_js_draw_string_latin1__sig: 'viiiiiiiiii',
  emx11_js_draw_string_latin1: function(id, x, y, fontPtr, textPtr, length, fg, bg, imageMode) {
    var font = fontPtr !== 0 ? UTF8ToString(fontPtr) : '13px monospace';
    var text = '';
  ...
  emx11_js_measure_font__sig: 'viiiii',
  ...
  emx11_js_measure_string__sig: 'iiii',
  ...
  emx11_js_measure_string_latin1__sig: 'iiii',
  emx11_js_measure_string_latin1: function(fontPtr, textPtr, length) {
    if (length <= 0 || textPtr === 0) return 0;
    var C = EmX11Host.caches;
    if (C.measureCtx === undefined) {
      var c = typeof OffscreenCanvas !== 'undefined' ? new OffscreenCanvas(1, 1)
  ...
  emx11_js_parse_color__sig: 'iiiii',
  ...
  emx11_js_put_image__sig: 'viiiiiiiiiiii',
  ...
  emx11_js_change_property__sig: 'iiiiiiii',
  ...
  emx11_js_get_property_meta__sig: 'viiiiii',
  ...
  emx11_js_get_property_data__sig: 'viiiiiiii',
  ...
  emx11_js_list_properties_fetch__sig: 'iiii',
  ...
  emx11_js_glx_create_context__sig: 'iiiii',
  emx11_js_glx_create_context: function(width, height, outTargetIdPtr, outTargetIdLen) {
    var h = EmX11Host.get();
    if (!h || !h.glx) return 0;
  ...
  emx11_js_glx_legacy_init_once__sig: 'v',
  emx11_js_glx_legacy_init_once: function() {
  ...
  emx11_js_glx_destroy_context__sig: 'vi',
  emx11_js_glx_destroy_context: function(id) {
    var h = EmX11Host.get();
    if (!h || !h.glx) return;
  ...
  emx11_js_glx_swap_buffers__sig: 'vii',
  emx11_js_glx_swap_buffers: function(id, drawable) {
    var h = EmX11Host.get();
    if (!h || !h.glx) return;
    h.glx.swapBuffers(id | 0, drawable >>> 0);
  },

  emx11_js_glx_resize__sig: 'viii',
  emx11_js_glx_resize: function(id, width, height) {
    var h = EmX11Host.get();
    if (!h || !h.glx) return;
