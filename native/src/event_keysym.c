 ...
 * emx11_install_keysym for each entry returned by
...
static const KeySym emx11_us_qwerty[256] = {
    /* 0..7 reserved by X11 */
    [9]   = 0xff1b, /* XK_Escape          */
    [10]  = '1',  [11]  = '2',  [12]  = '3',  [13]  = '4',
    [14]  = '5',  [15]  = '6',  [16]  = '7',  [17]  = '8',
    ...
    [67]  = 0xffbe, [68]  = 0xffbf, [69]  = 0xffc0, [70]  = 0xffc1,
    [71]  = 0xffc2, [72]  = 0xffc3, [73]  = 0xffc4, [74]  = 0xffc5,
    [75]  = 0xffc6, [76]  = 0xffc7, /* F1..F10           */
    [77]  = 0xff7f, /* XK_Num_Lock        */
    [78]  = 0xff14, /* XK_Scroll_Lock     */
    [79]  = 0xffb7, [80]  = 0xffb8, [81]  = 0xffb9, /* KP 7 8 9 */
    [82]  = 0xffad, /* XK_KP_Subtract     */
    [83]  = 0xffb4, [84]  = 0xffb5, [85]  = 0xffb6, /* KP 4 5 6 */
    [86]  = 0xffab, /* XK_KP_Add          */
    [87]  = 0xffb1, [88]  = 0xffb2, [89]  = 0xffb3, /* KP 1 2 3 */
    [90]  = 0xffb0, /* XK_KP_0            */
    [91]  = 0xffae, /* XK_KP_Decimal      */
    [94]  = '<',    /* ISO 105-key extra (less than on most layouts) */
    [95]  = 0xffc8, [96]  = 0xffc9, /* F11 F12          */
...
void emx11_keysym_table_install_us_qwerty(Display *dpy) {
    if (!dpy) return;
    memcpy(dpy->keysym_table, emx11_us_qwerty, sizeof(emx11_us_qwerty));
 ...
 * emx11_push_key_event_kc so XkbGetMap consumers always see the most
 * recent known keysym for each physical key. */
EMSCRIPTEN_KEEPALIVE
void emx11_install_keysym(unsigned int keycode, unsigned int keysym) {
    Display *dpy = emx11_get_display();
    if (!dpy || keycode == 0 || keycode >= 256) return;
...
KeyCode emx11_keysym_to_keycode(Display *dpy, KeySym keysym) {
    ...
    for (unsigned int i = dpy->next_keycode; i < 256; i++) {
        if (dpy->keysym_table[i] == NoSymbol) {
            ...
            if (i >= dpy->next_keycode) dpy->next_keycode = i + 1;
            return (KeyCode)i;
        }
    }
