...
struct _XDisplay {
  ...
  char key_text_queue[EMX11_EVENT_QUEUE_CAPACITY][EMX11_KEY_TEXT_SLOT];
...
extern void emx11_js_window_create(int conn_id,
                                   Window id,
                                   Window parent,
                                   int x,
                                   int y,
...
extern void
emx11_js_window_set_bg(Window id, int bg_type, unsigned long bg_value);
 ...
 * geometry fields. */
extern void emx11_js_window_configure(
...
extern void emx11_js_window_lower(Window id);
...
extern void
emx11_js_clear_area(Window id, int x, int y, unsigned int w, unsigned int h);
extern void emx11_js_fill_rect(
  Window id, int x, int y, unsigned int w, unsigned int h, unsigned long color);
extern void emx11_js_draw_line(Window id,
                               int x1,
                               int y1,
                               int x2,
                               int y2,
...
extern void emx11_js_draw_arc(Window id,
                              int x,
                              int y,
                              unsigned int width,
                              unsigned int height,
                              ...
                              unsigned long color,
                              int line_width);
extern void emx11_js_fill_arc(Window id,
                              int x,
                              int y,
                              unsigned int width,
                              unsigned int height,
...
extern void emx11_js_fill_polygon(Window id,
                                  const int* points,
                                  int count,
                                  int shape,
                                  int mode,
...
extern void emx11_js_draw_points(
...
extern void emx11_js_draw_string(Window id,
                                 int x,
                                 int y,
                                 const char* font_css,
                                 const char* text,
 ...
 * UTF-8 variant above. */
extern void emx11_js_draw_string_latin1(Window id,
                                        int x,
                                        int y,
                                        const char* font_css,
                                        const char* text,
...
extern void emx11_js_measure_font(
...
extern int
emx11_js_measure_string(const char* font_css, const char* text, int length);
...
extern int emx11_js_change_property(Window w,
                                    Atom atom,
                                    Atom type,
                                    int format,
                                    int mode,
 ...
 *   [7] reserved */
extern void emx11_js_get_property_meta(Window w,
                                       Atom atom,
                                       Atom req_type,
                                       long long_offset,
                                       long long_length,
                                       int* meta_out);
extern void emx11_js_get_property_data(Window w,
                                       Atom atom,
                                       Atom req_type,
                                       long long_offset,
                                       long long_length,
...
extern void emx11_js_pixmap_create(Pixmap id, int width, int height, int depth);
...
extern void emx11_js_shape_combine_mask(
  Window dest, Pixmap src, int x_off, int y_off, int op);
extern void
emx11_js_shape_select_input(int conn_id, Window window, unsigned long mask);
...
extern void emx11_js_copy_area(Drawable src,
                               Drawable dst,
                               int src_x,
                               int src_y,
                               unsigned int width,
                               ...
                               int dst_x,
                               int dst_y);
extern void emx11_js_copy_plane(Drawable src,
                                Drawable dst,
                                int src_x,
                                int src_y,
                                unsigned int width,
                                ...
                                unsigned long bg,
                                int apply_bg);
extern void emx11_js_put_image(Drawable dst,
                               int dst_x,
                               int dst_y,
                               unsigned int width,
                               unsigned int height,
                               ...
                               unsigned long fg,
                               unsigned long bg);
extern void emx11_js_get_image(Drawable drawable,
                               int x,
                               int y,
                               unsigned int w,
                               unsigned int h,
...
extern void emx11_js_grab_button(Window window,
                                 unsigned int button,
                                 ...
                                 Window confine_to,
                                 Cursor cursor);
extern void emx11_js_ungrab_button(Window window,
                                   unsigned int button,
                                   unsigned int modifiers);
...
extern void
emx11_js_grab_pointer(unsigned int conn_id, Window window, int owner_events);
