/*
 * Keysym name <-> code table and keysym <-> keycode mapping plus
 * XLookupString text translation.
 *
...
const struct KeysymEntry g_keysym_table[] = {
  {"BackSpace", 0xff08},
  {"Tab", 0xff09},
  {"Linefeed", 0xff0a},
  {"Clear", 0xff0b},
